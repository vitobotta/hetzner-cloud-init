...
To use this, just add this little YAML as cloud init config in the node template, specifying the Hetzner Cloud API token and a comma separated list of IPs that you want to whitelist in the firewall.
