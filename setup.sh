...
curl -o /usr/local/sbin/apt-get https://raw.githubusercontent.com/vitobotta/hetzner-cloud-init/master/apt-iq

chmod +x /usr/local/sbin/apt-iq

apt-iq install jq ufw fail2ban
